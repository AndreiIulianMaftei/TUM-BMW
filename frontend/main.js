...
function addChatMessage(text, sender) {
    ...
    // Use logo.png for assistant avatar with white background - use chat-logo-container as the avatar itself
    const avatarHTML = sender === 'assistant' 
        ? `<div class="chat-logo-container">
                <img src="logo.png" alt="AI Assistant" class="chat-logo-avatar" onerror="this.style.display='none'">
            </div>`
