...
function addChatMessage(text, sender) {
    ...
    // Use BMW logo for assistant, user icon for user
    const avatarHTML = sender === 'assistant' 
        ? `<div class="message-avatar assistant-avatar">
                <img src="icons/Logo.png" alt="AI Assistant" class="assistant-logo">
            </div>`
...
document.addEventListener('click', (e) => {
    if (historySidebar && historySidebar.classList.contains('open')) {
        // Check if click is outside both the sidebar and the history nav button
        const isClickInsideSidebar = historySidebar.contains(e.target);
        const isClickOnHistoryBtn = historyNavItem && historyNavItem.contains(e.target);
        
        if (!isClickInsideSidebar && !isClickOnHistoryBtn) {
