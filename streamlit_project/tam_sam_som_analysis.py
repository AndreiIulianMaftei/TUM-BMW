...
def generate_tam_sam_som_analysis(pdf_content: str) -> Dict[str, Any]:
    ...
    IMPORTANT: Search online for real automotive industry examples and include actual URLs to support each market segment.
    
    Create a JSON structure with the following EXACT format:
